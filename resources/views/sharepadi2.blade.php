...
<html lang="en">
    ...
    <body>
        ...
        <div class="text-center pt-24 pb-28">
        ...
        <div>
            <div class="pb-44">
                <div class="flex flex-cols gap-20 px-32">
                    <div
                        class="text-[20px] leading-[22px] rounded-[35px] bg-[#F0F0F0] text-center montserrat-regular pb-16 pt-28 px-20"
                    >
                        <div class="flex flex-cols -mt-48 justify-center">
                            <img
                                class="w-36 p-4 bg-[#F48857] border border-white border-[20px] rounded-full"
                        ...
                        <h1
                            class="text-[30px] leading-[35px] pt-10 text-[#F48857] montserrat-bold"
                        >
                            Audience Reach
                        </h1>
                        <p class="pt-2">
