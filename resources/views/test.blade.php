...
<body>
    <div style="
            ...
            ">
        <div class="bg-gradient-to-r from-black bg-opacity-90 via-black bg-opacity-75 to-black bg-opacity-55"></div>
    </div>
    <footer class="bg-[#151515] max-w-[100vw] px-14 py-3 flex-col flex lg:flex-row items-center justify-between">
        <div>
        ...
        <div>
            <div class="flex items-center">
                ...
                <img src="/images/bloom-logo-footer.png" class="pl-4 h-7 w-auto" alt="Bloom Logo" />
            </div>
        </div>
    </footer>
</body>
...
<div>
    ...
    <!-- <div
            style="background: url('/images/medium-shot-students.png')"
    ...
    <!-- <div
        ...
        >
            <div
                class="bg-gradient-to-r from-black bg-opacity-90 via-black bg-opacity-75 to-black bg-opacity-55"
            ></div>
        </div> -->
    <!-- <div
            style="background: url('/images/medium-shot-students.png')"
            class="w-[100vw] w-full h-[90vh] bg-contain bg-center bg-cover"
        ></div>
        <div
            class="absolute inset-0 bg-gradient-to-r from-black bg-opacity-90 via-black bg-opacity-75 to-black bg-opacity-55"
        ></div> -->

    <!-- <div class="relative h-90vh w-screen">
            <div
                class="absolute inset-0 bg-gradient-to-r from-black bg-opacity-90 via-black bg-opacity-75 to-black bg-opacity-55"
            ></div>
            <div
