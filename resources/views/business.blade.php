    ...
    <div class="h-[850px] sm:h-[1000px] md:h-[650px] lg:h-[710px] xl:h-[795px] bg-[#2D2D2B]">
        <nav class="hidden md:block top-0 left-0 right-0 bg-opacity-75 z-50">
            <div class="mx-auto px-6 py-8 flex justify-between">
                <a href="/" class="text-white font-semibold"><img src="/images/bloom-academy.svg" class=""
                        alt="Bloom Logo" /></a>
                <div class="flex text-[18px] leading-[36px] items-center justify-center poppins-medium space-x-16">
        ...
        <div
            ...
            <div class="text-center md:text-left pt-8 flex-1">
                ...
                <a href="#"
                    class="hidden md:block text-white text-base lg:text-xl bg-[#C73029] py-4 px-8 rounded-full montserrat-extra-bold md:w-3/6 lg:w-3/6 xl:w-2/5">Book
                    a Demo</a>
            </div>
