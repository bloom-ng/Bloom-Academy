...
<body class="">
    <div class="relative h-screen">
        <!-- Hero Section -->
        <div class="relative bg-cover bg-center h-[850px] md:h-[1250px]"
            style="
            ...
            <nav class="hidden md:block absolute top-0 left-0 right-0 bg-opacity-75 z-10">
                <div class="mx-auto px-10 lg:px-6 2xl:px-24 py-8 flex justify-between">
                    <a href="/" class="block 2xl:hidden text-white font-semibold"><img
                            src="/images/bloom-academy.svg" class="" alt="Bloom Logo" /></a>
                    <a href="/" class="hidden 2xl:block text-white font-semibold"><img
                            src="/images/bloom-academy.svg" class="w-[270px] h-[150px]" alt="Bloom Logo" /></a>
                    <div
                        ...
                        <div class="relative" id="dropdownButton">
                            ...
                            <div id="dropdown"
                                ...
                                <ul class="bg-white px-16 poppins-regular py-5 text-base text-black rounded-[35px]">
                                    <div class="relative" id="dropdownButton1">
                                        <div onclick="toggleDropdown1()" class="flex items-center justify-center">
                                            <li class="py-2 flex flex-row">
                                                Marketing
                                                <img class="pl-8" src="/images/Forward.svg" alt="" />
                                            </li>
                                        </div>
                                        <div id="dropdown1"
            ...
            <nav class="block md:hidden absolute top-0 left-0 right-0 bg-opacity-75 z-10">
                <section class="container mx-auto px-7 py-8 flex justify-between">
                    <a href="/">
                        <div class="logo">
                            <img src="/images/bloom-academy-mobile.svg" alt="" />
                        </div>
                    </a>
        ...
        <div class="relative h-[2120px] md:h-[1000px] bg-[#FFE8D1]">
            <div class="flex justify-center z-20 items-center">
                <div class="hidden md:block absolute flex justify-center z-20 items-center -mt-2">
                    <p class="bg-[#FF8100] text-[45px] leading-[50px] text-white poppins-bold px-16 py-6">
                        Our Courses
                    </p>
                </div>
            </div>
            <div class="absolute -mt-60 md:-mt-16 grid md:grid-cols-2 gap-12 md:gap-24 px-6 md:px-10 xl:px-32">
                <div
                    ...
                    <div class="mx-6 mt-8 sm:mx-10 md:mx-7 lg:mx-12 md:mt-16">
                        ...
                        <p class="text-base md:text-2xl mb-10 md:mb-48 poppins-regular mt-6">
                        ...
                        <a href="#"
                            class="text-white text-xl bg-[#C73029] py-4 px-8 rounded-full montserrat-extra-bold">Learn
                            More</a>
                    </div>
                </div>
                <div
                    ...
                    <div class="mx-6 mt-8 sm:mx-10 md:mx-7 lg:mx-12 md:mt-16">
                        ...
                        <a href="#"
                            class="text-white text-xl bg-[#C73029] py-4 px-8 rounded-full montserrat-extra-bold">Register</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <footer
            ...
            <div class="flex text-white lg:flex-row gap-20 items-center justify-between">
                <ul class="flex flex-col items-left list-none">
                    <li class="montserrat-bold mb-4 text-[9px] lg:text-sm">
                        Company
                    </li>
                    <li class="montserrat-extra-light mb-2 text-[9px] lg:text-sm">
                        About
                    </li>
                    <li class="montserrat-extra-light mb-2 text-[9px] lg:text-sm">
            ...
            <div>
                <div>
                    <div class="flex items-center justify-end">
                        ...
                        <p class="text-white text-[9px] lg:text-xs montserrat-extra-light leading-10 lg:mb-0">
                ...
                <div>
                    <div class="flex items-center">
                        <p class="text-white mt-3 text-[9px] lg:text-xs montserrat-extra-light leading-10 lg:mb-0">
