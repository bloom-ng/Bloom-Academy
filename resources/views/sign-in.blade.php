...
<body class="">
    <div class="grid grid-cols-2">
        ...
        <div class="flex justify-center items-center bg-[#2D2D2B]">
            <div class="flex flex-col bg-white rounded-[43px] px-[74px] pt-16 pb-10 items-center justify-center">
                <div class="items-center justify-center flex flex-col pb-8">
                    <p class="text-[26px] text-center leading-[23px] poppins-bold">
                ...
                <div class="">
                    <div class="relative">
                        <div class="absolute inset-y-0 start-0 flex items-center ps-5">
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute inset-y-0 end-0 flex items-center pe-5">
                            <img class="w-4" src="/images/hide.svg" alt="" />
                        </div>
                    </div>
                    <div class="relative">
                        <div class="flex text-[11px] justify-end poppins-medium text-[12px] mt-4 mb-8">
                            <p>Forgot Password?</p>
                        </div>
                    </div>
                </div>
                <div>
                    <a href="#"
                        class="text-white text-xl leading-[45px] bg-[#C73029] py-3 px-40 rounded-full montserrat-bold">Log
                        In</a>
                </div>
                <div class="items-center justify-center flex flex-col mt-24">
                    <p class="text-[13px] leading-[50px] poppins-medium">
                        Don't have an account?
                        <span class="text-[#FF8100]"><a href="#">Register</a></span>
                    </p>
                </div>
            </div>
        </div>
